...
use carbide_vulkano::{Image as VulkanoGuiImage, Renderer};
...
fn main() {
    ...
    'main: loop {
        ...
        events_loop.poll_events(|event| {
            // Convert winit event to carbide event.
            // Function generated by `carbide_winit::conversion_fns` in `support` module.
