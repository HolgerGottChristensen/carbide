    ...
    ($event:expr, $window:expr) => {{
        ...
        match $event {
            winit::event::WindowEvent::Resized(physical_size) => {
                ...
                Some(conrod_core::event::input::Input::Resize(width, height).into())
            },
            ...
            winit::event::WindowEvent::Focused(focused) =>
                Some(conrod_core::event::input::Input::Focus(focused.clone()).into()),
            ...
            winit::event::WindowEvent::MouseInput { state, button, .. } => match state {
                winit::event::ElementState::Pressed =>
                    Some(conrod_core::event::input::Input::Press(conrod_core::input::Button::Mouse(map_mouse(button.clone()))).into()),
                winit::event::ElementState::Released =>
                    Some(conrod_core::event::input::Input::Release(conrod_core::input::Button::Mouse(map_mouse(button.clone()))).into()),
            },
