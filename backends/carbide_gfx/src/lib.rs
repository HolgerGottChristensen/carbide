//! A gfx backend for rendering carbide primitives.
...
impl<'a, R: Resources> Renderer<'a, R> {
              ...
              C: gfx::CommandBuffer<R>,
    {
        ...
        // Functions for converting for carbide scalar coords to GL vertex coords (-1.0 to 1.0).
    ...
    /// Call this routine when a window has been resized. This ensures that carbide primitives are
