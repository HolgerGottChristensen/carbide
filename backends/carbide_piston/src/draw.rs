//! A piston backend for rendering carbide primitives.
...
/// Render the given sequence of carbide primitive widgets.
///
/// Params:
///
          ...
          F: FnMut(&Img) -> &T,
{
    ...
    // Translate the `context` to suit carbide's orientation (middle (0, 0), y pointing upwards).
