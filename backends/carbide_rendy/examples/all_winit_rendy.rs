...
use carbide_rendy::{UiTexture, UiPipeline, SimpleUiAux};
use image;
use rendy::{
...
carbide_winit::v020_conversion_fns!();
...
fn main() {
    ...
    let window_builder = WindowBuilder::new()
        ...
        .with_title("carbide with Rendy and winit");
    ...
    rendy::with_any_windowed_rendy!((rendy)
        (mut factory, mut families, surface, window) => {
            ...
            let mut image_map = carbide_core::image::Map::new();
            let rust_logo = image_map.insert(image);
            let app = carbide_example_shared::DemoApp::new(rust_logo);
