use carbide_core::image::{Id as ImageId, ImageMap as ImageMap};
use carbide_core::mesh::{self, Mesh};
...
pub trait UiAux {
    ...
    /// The DPI factor for translating from carbide's pixel-agnostic coordinates to pixel
...
/// A simple type that wraps a rendy `Texture` and provides a `carbide_core::mesh::ImageDimensions`
/// implementation.
...
impl Default for UiPipelineDesc {
    fn default() -> Self {
        let glyph_cache_dimensions = carbide_core::mesh::DEFAULT_GLYPH_CACHE_DIMS;
        UiPipelineDesc {
    ...
    T: UiAux<Backend = B>,
{
    ...
    fn prepare(
        ...
        // TODO: Remove this in favour of `unsafe`ly casting the `&[carbide_core::mesh::Vertex]`
