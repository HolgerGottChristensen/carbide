// //! This crate is used for sharing a few items between the carbide examples.
// //!
// //! The module contains:
// //!
...
//
// /// A demonstration of some application state we want to control with a carbide GUI.
// pub struct DemoApp {
//     ball_xy: carbide_core::Point,
//     ball_color: carbide_core::Color,
//     sine_frequency: f32,
//     rust_logo: carbide_core::image::Id,
// }
//
// impl DemoApp {
//     /// Simple constructor for the `DemoApp`.
//     pub fn new(rust_logo: carbide_core::image::Id) -> Self {
//         DemoApp {
//             ball_xy: [0.0, 0.0],
//             ball_color: carbide_core::color::WHITE,
//             sine_frequency: 1.0,
//             rust_logo: rust_logo,
//         }
//     }
...
// pub fn theme() -> carbide_core::Theme {
//     use carbide_core::position::{Align, Direction, Padding, Position, Relative};
//     carbide_core::Theme {
//         name: "Demo Theme".to_string(),
//         padding: Padding::none(),
//         x_position: Position::Relative(Relative::Align(Align::Start), None),
//         y_position: Position::Relative(Relative::Direction(Direction::Backwards, 20.0), None),
//         background_color: carbide_core::color::DARK_CHARCOAL,
//         shape_color: carbide_core::color::LIGHT_CHARCOAL,
//         border_color: carbide_core::color::BLACK,
//         border_width: 0.0,
...
//         font_size_medium: 18,
//         font_size_small: 12,
//         widget_styling: carbide_core::theme::StyleMap::default(),
...
// }
//
// /// Instantiate a GUI demonstrating every widget available in carbide.
// pub fn gui(ui: &mut carbide_core::UiCell, ids: &Ids, app: &mut DemoApp) {
//     use carbide_core::{widget, Colorable, Labelable, Positionable, Sizeable, OldWidget};
//     use std::iter::once;
//
//     const MARGIN: carbide_core::Scalar = 30.0;
//     const SHAPE_GAP: carbide_core::Scalar = 50.0;
//     const TITLE_SIZE: carbide_core::FontSize = 42;
//     const SUBTITLE_SIZE: carbide_core::FontSize = 32;
//
...
//         "This example aims to demonstrate all widgets that are provided by carbide.\
...
//          all other widget render. These render are \"special\" in the sense that carbide knows \
//          how to render them via `carbide_core::render::Primitive`s.\
...
//     //
//     // TODO: Have carbide provide an auto-flowing, fluid-list widget that is more adaptive for these
//     // sorts of situations.
//     widget::Canvas::new()
//         .down(0.0)
//         .align_middle_x_of(ids.canvas)
...
//         .h(360.0)
//         .color(carbide_core::color::TRANSPARENT)
//         .pad(MARGIN)
//         .flow_down(&[
...
//         .color(carbide_core::color::CHARCOAL.alpha(0.25))
...
//
//     const LOGO_SIDE: carbide_core::Scalar = 144.0;
...
//         .set(ids.button, ui)
//     {
//         let x = rand::random::<carbide_core::Scalar>() * (max_x - min_x) - max_x;
//         let y = rand::random::<carbide_core::Scalar>() * (max_y - min_y) - max_y;
//         app.ball_xy = [x, y];
//     }
//
...
//     }
//
//     let is_white = app.ball_color == carbide_core::color::WHITE;
//     let label = if is_white { "WHITE" } else { "BLACK" };
//     for is_white in widget::Toggle::new(is_white)
//         .label(label)
//         .label_color(if is_white {
//             carbide_core::color::WHITE
//         } else {
//             carbide_core::color::LIGHT_CHARCOAL
//         })
