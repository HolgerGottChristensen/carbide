    ...
    window.set_widgets(
        VStack::new(vec![
            HStack::new(vec![
                ...
                Rectangle::new()
                    .fill(Gradient::linear(colors.clone(), Alignment::Leading, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::radial(colors.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::diamond(colors.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::conic(colors.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
            ]),
            HStack::new(vec![
            ...
            HStack::new(vec![
                ...
                RoundedRectangle::new(10.0)
                    .fill(Gradient::linear(colors.clone(), Position::new(0.0, 0.0), Position::new(10.0, 10.0)).repeat())
                    .frame(80.0, 80.0),
                RoundedRectangle::new(10.0)
                    .fill(Gradient::linear(colors.clone(), Position::new(0.0, 0.0), Position::new(10.0, 10.0)).repeat())
                    .frame(80.0, 80.0),
                Circle::new()
                    .fill(Gradient::radial(colors.clone(), Position::new(0.0, 0.0), Position::new(10.0, 20.0)).repeat())
                    .frame(80.0, 80.0),
                Circle::new()
                    .fill(Gradient::radial(colors.clone(), Position::new(0.0, 0.0), Position::new(10.0, 20.0)).repeat())
                    .frame(80.0, 80.0),
            ...
            HStack::new(vec![
                ...
                Rectangle::new()
                    .fill(Gradient::linear(colors1.clone(), Alignment::Leading, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::radial(colors1.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::diamond(colors1.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::conic(colors1.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
            ]),
            HStack::new(vec![
                // Gradients can not only be used to fill shapes, but also to stroke shapes.
                Rectangle::new()
                    .stroke(Gradient::linear(colors1.clone(), Alignment::Leading, Alignment::Trailing))
                    .stroke_style(10.0)
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .stroke(Gradient::radial(colors1.clone(), Alignment::Center, Alignment::BottomTrailing))
                    .stroke_style(10.0)
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .stroke(Gradient::diamond(colors1.clone(), Alignment::Center, Alignment::BottomTrailing))
                    .stroke_style(10.0)
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .stroke(Gradient::conic(colors1.clone(), Alignment::Center, Alignment::Trailing))
                    .stroke_style(10.0)
                    .frame(80.0, 80.0),
            ]),
            HStack::new(vec![
                ...
                Rectangle::new()
                    .fill(Gradient::linear(colors2.clone(), Alignment::Leading, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::radial(colors2.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::diamond(colors2.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
                Rectangle::new()
                    .fill(Gradient::conic(colors2.clone(), Alignment::Center, Alignment::Trailing))
                    .frame(80.0, 80.0),
            ]),
        ])
    );
