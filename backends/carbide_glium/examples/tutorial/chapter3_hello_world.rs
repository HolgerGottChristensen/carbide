...
use carbide_core::{widget, Positionable, Colorable, Widget};
use glium::Surface;
...
fn main() {
    ...
    let image_map = carbide_core::image::Map::<glium::texture::Texture2d>::new();
    ...
    'main: loop {
        ...
        for event in event_loop.next(&mut events_loop) {
            ...
            if let Some(event) = carbide_winit::convert_event(event.clone(), &display) {
...
impl carbide_winit::WinitWindow for GliumDisplayWinitWrapper {
