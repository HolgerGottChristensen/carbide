//!
//! A demonstration of all non-primitive widgets available in carbide.
//!
//!
//! Don't be put off by the number of method calls, they are only for demonstration and almost all
//! of them are optional. carbide supports `Theme`s, so if you don't give it an argument, it will
...
impl DemoApp {
    ...
    fn new() -> DemoApp {
        DemoApp {
            bg_color: carbide_core::color::rgb(0.2, 0.35, 0.45),
            show_button: false,
...
//
// To make this easier, carbide provides the `widget_ids` macro. This macro generates a new type
