...
mod circular_button {
    ...
    //    the field's `#[carbide(default = "expr")]` attribute.
    ...
    pub struct Style {
        ...
        pub color: Option<carbide_core::Color>,
        /// Color of the button's label.
        #[carbide(default = "theme.label_color")]
        pub label_color: Option<carbide_core::Color>,
    ...
    impl<'a> CircularButton<'a> {
        ...
        /// other carbide configs, this returns self for chainability. Allow dead code
    ...
    impl<'a> OldWidget for CircularButton<'a> {
        ...
        fn is_over(&self) -> widget::IsOverFn {
            use carbide_core::graph::Container;
            use carbide_core::Theme;
        ...
        fn update(self, args: widget::UpdateArgs<Self>) -> Self::Event {
            ...
            //
            // carbide will automatically determine whether or not any changes have occurred and
            ...
            // carbide's backend to do the actual drawing. This allows us to build up more complex
            // widgets by using these simple primitives with our familiar layout, coloring, etc
            // methods.
            //
            // If you notice that carbide is missing some sort of primitive graphics that you
    ...
    impl<'a> Colorable for CircularButton<'a> {
        fn color(mut self, color: carbide_core::Color) -> Self {
    ...
    impl<'a> Labelable<'a> for CircularButton<'a> {
        ...
        fn label_color(mut self, color: carbide_core::Color) -> Self {
            self.style.label_color = Some(color);
            self
        }
        fn label_font_size(mut self, size: carbide_core::FontSize) -> Self {
    ...
    'main: loop {
        ...
        // Instantiate the widgets.
        {
            ...
            for _click in CircularButton::new()
                .color(carbide_core::color::rgb(0.0, 0.3, 0.1))
                .middle_of(ids.background)
                .w_h(256.0, 256.0)
                .label_font_id(regular)
                .label_color(carbide_core::color::WHITE)
                .label("Circular Button")
                // Add the widget to the carbide_core::Ui. This schedules the widget it to be
