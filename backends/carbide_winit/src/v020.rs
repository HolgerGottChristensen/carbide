...
macro_rules! v020_convert_key {
    ($keycode:expr) => {{
        match $keycode {
            ...
            winit::event::VirtualKeyCode::Divide => carbide_core::input::keyboard::Key::NumPadDivide,
            ...
            winit::event::VirtualKeyCode::Add => carbide_core::input::keyboard::Key::NumPadPlus,
    ...
    ($event:expr, $window:expr) => {{
        ...
        match $event {
            winit::event::WindowEvent::Resized(winit::dpi::LogicalSize { width, height }) => {
                Some(carbide_core::event::Input::Resize(width as _, height as _).into())
            },
            ...
            winit::event::WindowEvent::Focused(focused) =>
                Some(carbide_core::event::Input::Focus(focused).into()),
            ...
            winit::event::WindowEvent::MouseInput { state, button, .. } => match state {
                winit::event::ElementState::Pressed =>
                    Some(carbide_core::event::Input::Press(carbide_core::input::Button::Mouse(map_mouse(button))).into()),
                winit::event::ElementState::Released =>
                    Some(carbide_core::event::Input::Release(carbide_core::input::Button::Mouse(map_mouse(button))).into()),
            },

            winit::event::WindowEvent::RedrawRequested => {
                Some(carbide_core::event::Input::Redraw)
            },
...
macro_rules! v020_conversion_fns {
    () => {
        ...
        pub fn convert_key(keycode: winit::event::VirtualKeyCode) -> carbide_core::input::keyboard::Key {
        ...
        /// Convert a given carbide mouse cursor to the corresponding winit cursor type.
        pub fn convert_mouse_cursor(cursor: carbide_core::cursor::MouseCursor) -> winit::window::CursorIcon {
