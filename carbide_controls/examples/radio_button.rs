...
fn main() {
    ...
    window.set_widgets(SharedState::new(
        shape_state.clone(),
        VStack::new(vec![
            RadioButton::new("Rectangle", Shape::Rectangle, shape_state.clone()).frame(100.0, 26.0),
            RadioButton::new("Circle", Shape::Circle, shape_state.clone()).frame(100.0, 26.0),
            RadioButton::new("Triangle", Shape::Triangle, shape_state.clone()).frame(100.0, 26.0),
            RadioButton::new("Star", Shape::Star, shape_state.clone()).frame(100.0, 26.0),
        ])
            .spacing(10.0)
