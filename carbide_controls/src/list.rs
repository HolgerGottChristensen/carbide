        ...
        T: ListIndex + 'static,
{
    ...
    #[state]
    internal_model: Box<dyn State<Vec<T>, GS>>,
    #[state]
    index_offset: Box<dyn State<usize, GS>>,
    #[state]
    start_offset: Box<dyn State<f64, GS>>,
    #[state]
    end_offset: Box<dyn State<f64, GS>>,
