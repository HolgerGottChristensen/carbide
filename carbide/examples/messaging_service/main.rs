...
use carbide_controls::{Button, capture, List, TextInput};
use carbide_core::environment::{Environment, EnvironmentColor};
use carbide_core::prelude::{TState, State};
...
fn main() {
    ...
    let model = LocalState::new(vec![
        ...
        Message::new("Carl you made an error in the file".to_string(), "Mark".to_string()),
    ]);

    let mut list = List::new(model.clone(), list_delegate)
        .spacing(20.0);
