...
/// The result of a carbide_syn parser.
pub type Result<T> = std::result::Result<T, Error>;

/// Error returned when a carbide_syn parser cannot parse the input tokens.
///
...
/// use carbide_syn::parse::{Parse, ParseStream, Result};
/// use carbide_syn::{parse_macro_input, ItemFn};
///
...
///
///     // fn(DeriveInput) -> carbide_syn::Result<proc_macro2::TokenStream>
///     expand::my_derive(input)
///         .unwrap_or_else(carbide_syn::Error::into_compile_error)
///         .into()
/// }
/// #
/// # mod expand {
/// #     use proc_macro2::TokenStream;
/// #     use carbide_syn::{DeriveInput, Result};
/// #
...
impl Error {
    ...
    ///
    /// ```
    /// use carbide_syn::{Error, Ident, LitStr, Result, Token};
    ...
    /// #
    /// use proc_macro::TokenStream;
    /// use carbide_syn::{parse_macro_input, DeriveInput, Error};
    ///
