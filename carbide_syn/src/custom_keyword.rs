...
/// ```
/// mod kw {
///     carbide_syn::custom_keyword!(whatever);
/// }
/// ```
///
...
/// not considered keywords in the `carbide_syn::token` module. Like any other
/// identifier that is not a keyword, these can be declared as custom keywords
/// by crates that need to use them as such.
///
/// ```
/// use carbide_syn::{LitBool, LitStr, Result, Token};
/// use carbide_syn::parse::{Parse, ParseStream};
///
/// mod kw {
///     carbide_syn::custom_keyword!(bool);
///     carbide_syn::custom_keyword!(str);
/// }
///
/// enum Argument {
///     Bool {
