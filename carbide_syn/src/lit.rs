...
ast_enum_of_structs! {
    ...
    pub enum Lit {
        ...
        /// A raw token literal not interpreted by carbide_syn.
        Verbatim(Literal),
    }
}
...
impl LitStr {
    ...
    ///
    /// ```
    /// use carbide_syn::{Attribute, Error, Expr, Lit, Meta, Path, Result};
    ///
    ...
    /// let basic_path = lit_str.parse_with(carbide_syn::Path::parse_mod_style)?;
    /// #
    /// #     Ok(())
    /// # }
    /// ```
...
mod value {
    ...
    impl Lit {
        /// Interpret a carbide_syn literal from a proc-macro2 literal.
