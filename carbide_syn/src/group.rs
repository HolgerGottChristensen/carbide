...
/// # use quote::quote;
/// #
/// use carbide_syn::{braced, token, Ident, Result, Token, Type};
/// use carbide_syn::parse::{Parse, ParseStream};
/// use carbide_syn::punctuated::Punctuated;
///
...
/// #         }
/// #     };
/// #     carbide_syn::parse2::<Struct>(input).unwrap();
/// # }
/// ```
#[macro_export]
#[cfg_attr(doc_cfg, doc(cfg(feature = "parsing")))]
...
/// use carbide_syn::{bracketed, token, Result, Token};
/// use carbide_syn::parse::{Parse, ParseStream};
///
...
/// #         #[repr(C, packed)]
/// #     };
/// #     carbide_syn::parse2::<OuterAttribute>(input).unwrap();
/// # }
/// ```
#[macro_export]
#[cfg_attr(doc_cfg, doc(cfg(feature = "parsing")))]
