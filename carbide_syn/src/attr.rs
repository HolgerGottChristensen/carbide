...
ast_struct! {
    ...
    ///
    /// ```
    /// # use carbide_syn::{ItemMod, parse_quote};
...
impl Attribute {
    ...
    /// doing `carbide_syn::parse2::<T>(meta_list.tokens)`, except that using
    ...
    ///
    /// ```
    /// use carbide_syn::{parse_quote, Attribute, Expr};
    ///
    ...
    ///
    /// ```
    /// use carbide_syn::{parenthesized, parse_quote, token, ItemStruct, LitInt};
    ///
    ...
    ///
    /// ```
    /// # use carbide_syn::{parse_quote, ItemStruct};
    /// #
    /// # let input: ItemStruct = parse_quote! {
    /// #     #[repr(C, align(4))]
    /// #     pub struct MyStruct(u16, u32);
    ...
    /// use carbide_syn::{parenthesized, token, Error, LitInt, Meta, Token};
    ///
    /// let mut repr_c = false;
    /// let mut repr_transparent = false;
    /// let mut repr_align = None::<usize>;
