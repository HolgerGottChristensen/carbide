...
///
/// ```
/// carbide_syn::custom_punctuation!(LeftRightArrow, <=>);
/// ```
///
...
/// use carbide_syn::parse::{Parse, ParseStream, Peek, Result};
/// use carbide_syn::punctuated::Punctuated;
/// use carbide_syn::Expr;
///
/// carbide_syn::custom_punctuation!(PathSeparator, </>);
///
/// // expr </> expr </> expr ...
/// struct PathSegments {
...
///         segments.push_value(carbide_syn::parse2(first)?);
///
///         while input.peek(PathSeparator) {
///             segments.push_punct(input.parse()?);
///
///             let next = parse_until(input, PathSeparator)?;
///             segments.push_value(carbide_syn::parse2(next)?);
///         }
///
...
///     let _: PathSegments = carbide_syn::parse_str(input).unwrap();
/// }
/// ```
#[macro_export]
