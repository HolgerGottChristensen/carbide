...
//!
//! ```
//! # use carbide_syn::{Attribute, Expr, Ident, Token, Type, Visibility};
//! #
...
//!
//! ```
//! use carbide_syn::{Attribute, Result};
...
///
/// This trait is sealed and cannot be implemented for types outside of carbide_syn.
#[cfg(feature = "parsing")]
