...
///
/// This trait is sealed and cannot be implemented for types outside of carbide_syn. It
...
pub trait IdentExt: Sized + private::Sealed {
    ...
    ///
    /// ```
    /// use carbide_syn::{Error, Ident, Result, Token};
    /// use carbide_syn::ext::IdentExt;
    /// use carbide_syn::parse::ParseStream;
    ///
    /// mod kw {
    ///     carbide_syn::custom_keyword!(name);
    /// }
    ///
