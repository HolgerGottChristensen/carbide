...
/// ```
/// use quote::quote;
/// use carbide_syn::{parse_quote, Stmt};
///
/// fn main() {
///     let name = quote!(v);
///     let ty = quote!(u8);
...
/// ```
///
/// *This macro is available only if carbide_syn is built with both the `"parsing"` and
/// `"printing"` features.*
///
/// # Example
///
...
///
/// ```
/// use carbide_syn::{parse_quote, Generics, GenericParam};
///
...
/// use carbide_syn::{parse_quote_spanned, ReturnType, Signature};
///
