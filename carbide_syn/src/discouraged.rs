...
pub trait Speculative {
    ...
    ///
    /// This change in behavior can be implemented in carbide_syn by replacing just the
    /// `Parse` implementation for `PathSegment`:
    ///
    /// ```
    /// # use carbide_syn::ext::IdentExt;
    /// use carbide_syn::parse::discouraged::Speculative;
    /// # use carbide_syn::parse::{Parse, ParseStream};
    /// # use carbide_syn::{Ident, PathArguments, Result, Token};
    ///
    ...
    /// }
    ///
    /// # carbide_syn::parse_str::<PathSegment>("a<b,c>").unwrap();
    /// ```
    ///
    /// # Drawbacks
    ///
