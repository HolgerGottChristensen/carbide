...
// use carbide_core::{widget, OldRect};
...
//     let widget_area = OldRect::from_corners([10.0, 10.0], [50.0, 50.0]);
...
//     push_event(
//         &mut global_input,
//         event::Event::Raw(Input::Motion(
//             crate::carbide_core::input::Motion::MouseRelative { x: 30.0, y: 30. },
//         )),
//     );
//     push_event(
//         &mut global_input,
...
//
//     let widget_input =
//         input::Widget::for_widget(widget::WidgetId::new(2), widget_area, &global_input);
//
...
//
//     let widget_area = OldRect::from_corners([0.0, 0.0], [40.0, 40.0]);
