...
impl ImageContext for NOOPImageContext {
    fn texture_exist(&self, _id: &ImageId, env: &mut Environment) -> bool {
        unimplemented!()
    }

    fn texture_dimensions(&self, _id: &ImageId, env: &mut Environment) -> Option<(u32, u32)> {
        unimplemented!()
    }

    fn update_texture(&mut self, _id: ImageId, _texture: Texture, env: &mut Environment) -> bool {
        unimplemented!()
    }
}