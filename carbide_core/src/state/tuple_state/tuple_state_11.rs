...
impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, GS> TupleState11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, GS>
    where T1: StateContract,
          ...
          T11: StateContract,
          GS: GlobalState {
    pub fn new<IT1, IT2, IT3, IT4, IT5, IT6, IT7, IT8, IT9, IT10, IT11>(
        first: IT1,
        second: IT2,
        third: IT3,
        fourth: IT4,
...
impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, GS> Into<TState<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11), GS>> for Box<TupleState11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, GS>>
    where T1: StateContract + 'static,
          ...
          GS: GlobalState {
    fn into(self) -> TState<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11), GS> {
