...
#[derive(Clone)]
pub struct TupleState10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS>
    ...
    ninth: TState<T9, GS>,
    tenth: TState<T10, GS>,
    latest_value: (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10),
}

impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS> TupleState10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS>
    where T1: StateContract,
          T2: StateContract,
          T3: StateContract,
          T4: StateContract,
          ...
          T10: StateContract,
          GS: GlobalState {
    pub fn new<IT1, IT2, IT3, IT4, IT5, IT6, IT7, IT8, IT9, IT10>(
        first: IT1,
        second: IT2,
        third: IT3,
        fourth: IT4,
        ...
        ninth: IT9,
        tenth: IT10,
    ) -> Box<TupleState10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS>>
        where
...
/*impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS> From<(
    Box<dyn State<T1, GS>>,
    Box<dyn State<T2, GS>>,
    Box<dyn State<T3, GS>>,
    Box<dyn State<T4, GS>>,
...
)> for TupleState10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS>
    where T1: StateContract,
          T2: StateContract,
          T3: StateContract,
          T4: StateContract,
          ...
          T10: StateContract,
          GS: GlobalState {
    fn from((first, second, third, fourth, fifth, sixth, seventh, eighth, ninth, tenth): (
        Box<dyn State<T1, GS>>,
        Box<dyn State<T2, GS>>,
        Box<dyn State<T3, GS>>,
        Box<dyn State<T4, GS>>,
...
impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS> Into<TState<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), GS>> for Box<TupleState10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS>>
    where T1: StateContract + 'static,
          ...
          GS: GlobalState {
    fn into(self) -> TState<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), GS> {
        WidgetState::new(self)
    }
}


impl<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS> State<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10), GS> for TupleState10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, GS>
    where T1: StateContract,
          T2: StateContract,
          T3: StateContract,
          T4: StateContract,
    ...
    fn get_value_mut(&mut self, env: &mut Environment<GS>, global_state: &mut GS) -> &mut (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) {
        self.latest_value = (
    ...
    fn get_value(&mut self, env: &Environment<GS>, global_state: &GS) -> &(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) {
        self.latest_value = (
    ...
    fn get_latest_value(&self) -> &(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) {
        &self.latest_value
    }

    fn get_latest_value_mut(&mut self) -> &mut (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) {
        &mut self.latest_value
    }
