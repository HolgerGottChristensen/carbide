...
impl<T1, T2, T3, T4, T5, T6, T7, GS> Into<TState<(T1, T2, T3, T4, T5, T6, T7), GS>> for Box<TupleState7<T1, T2, T3, T4, T5, T6, T7, GS>>
    where T1: StateContract + 'static,
          ...
          GS: GlobalStateContract {
    fn into(self) -> TState<(T1, T2, T3, T4, T5, T6, T7), GS> {
