...
// /// #[macro_use] extern crate carbide_derive;
// ///
// /// #[derive(WidgetCommon)]
// /// struct MyWidget {
// ///     #[carbide(common_builder)]
// ///     common: carbide_core::widget::CommonBuilder,
// ///     // etc
// /// }
// /// ```
// pub trait Common {
...
//     /// calls to `update`.
//     ///
//     /// carbide will never clone the state, it will only ever be moved.
...
//     /// the new style each time `.set` is called, allowing carbide to automatically determine
...
//     /// type itself) is so that carbide can distinguish between default style data that may be
...
//     /// boilerplate when written by hand. To get around this, carbide provides
//     /// `#[derive(WidgetStyle)]`.
//     ///
//     /// This procedural macro generates a "getter"-style method for each struct field that is
//     /// decorated with a `#[carbide(default = "expr")]` attribute. The generated methods have the
...
//     ///    within the field's `#[carbide(default = "expr")]` attribute.
//     ///
...
//     /// # extern crate carbide_core;
//     /// # #[macro_use] extern crate carbide_derive;
//     /// # use carbide_core::{Color, FontSize, Scalar};
//     /// # fn main() {}
...
//     ///     #[carbide(default = "carbide_core::color::BLACK")]
...
//     /// If `false`, the **Widget** will be placed on the parent **Widget**'s *total* area.
//     ///
//     /// By default, carbide will automatically determine this for you by checking whether or not the
