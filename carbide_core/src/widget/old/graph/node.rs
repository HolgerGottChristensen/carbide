...
pub struct Style {
    ...
    #[carbide(default = "color::TRANSPARENT")]
    ...
    /// Color of the border.
    #[carbide(default = "color::DARK_CHARCOAL")]
    pub border_color: Option<Color>,
    /// Color of the sockets.
    #[carbide(default = "color::DARK_GREY")]
    pub socket_color: Option<Color>,
    /// Default layout for input sockets.
    #[carbide(default = "SocketLayout { side: SocketSide::Left, direction: Direction::Backwards }")]
    pub input_socket_layout: Option<SocketLayout>,
    /// Default layout for node output sockets.
    #[carbide(default = "SocketLayout { side: SocketSide::Right, direction: Direction::Backwards }")]
