//! The widget identifier type used throughout carbide, along with helper render and macros to
...
/// # fn main() {}
/// struct Ids {
///     button: carbide_core::widget::Id,
///     toggles: carbide_core::widget::id::List,
/// }
///
/// impl Ids {
///     pub fn new(mut generator: carbide_core::widget::id::Generator) -> Self {
///         Ids {
///             button: generator.next(),
///             toggles: carbide_core::widget::id::List::new(),
///         }
///     }
/// }
/// ```
...
macro_rules! widget_ids {
    ...
    // Converts `foo[]` tokens to `foo: carbide_core::widget::id::List`.
    ...
    // Converts `foo` tokens to `foo: carbide_core::widget::Id`.
    (define_struct $(#[$attr:meta])* [$($public:tt)*] $Ids:ident {
        { $($id_field:ident: $T:path,)* } $id:ident, $($rest:tt)*
    }) => {
        widget_ids! {
    ...
    // Converts `foo[]` to `foo: carbide_core::widget::id::List::new()`.
