...
carbide is a portable, 2D, [GUI][1] library for the [Rust programming language][2].
...
If you have an awesome looking GUI made with carbide, please send us a screenshot and we'll add it here :)

Here's [a youtube demo](https://www.youtube.com/watch?v=n2UrjogA0j0) of the all widgets example.

Here's [another youtube demo](https://www.youtube.com/watch?v=_ZXLCVibI8c) of carbide being used to create a basic synth editor.

**A multimedia timeline widget.**

<img src="http://imgur.com/34NEw90.png" alt="timeline" style="width:700px;">

**The [all_piston_window.rs example](https://github.com/PistonDevelopers/carbide/blob/master/backends/carbide_piston/examples/all_piston_window.rs).**

<img src="http://i.imgur.com/xKXISdc.png" alt="all_widgets.rs" style="width:700px;">

**The [canvas.rs example](https://github.com/PistonDevelopers/carbide/blob/master/backends/carbide_glium/examples/canvas.rs).**
...
The widgets that are provided by carbide can be broken into two sets: [**primitive**][3] and [**common
use**][4].


### Primitive Widgets

Primitive widgets are the fundamental graphical components in any carbide user interface. They are a
...
When drawing the widget graph to the screen, carbide *only* draws the primitive widgets. This allows
...
The following are the primitive widgets provided by carbide:
...
If carbide is lacking a primitive widget that you require, please let us know! There are currently
...
The following are the common use widgets provided by carbide:
...
- [Menu Bar / Tool Bar](https://github.com/PistonDevelopers/carbide/issues/417)
- [Right-click Context Menu](https://github.com/PistonDevelopers/carbide/issues/394)
- [Graph / Chart](https://github.com/PistonDevelopers/carbide/issues/84)
- [File/Directory Navigator](https://github.com/PistonDevelopers/carbide/issues/381)
...
make a nice addition to carbide, please let us know by leaving an [issue][5] or [pull request][6]!
Be sure to check [issues with the widget
label](https://github.com/PistonDevelopers/carbide/issues?q=is%3Aopen+is%3Aissue+label%3Awidget)
...
### Is carbide Immediate or Retained?

carbide aims to adopt the best of both worlds by providing an immediate mode API over a hidden,
retained widget state graph. From the user's perspective carbide widgets tend to feel stateless, as
...
stage that is more suited to the user's application. As a result, carbide should be able to provide
...
carbide uses this pattern within its API for widget instantiation. This pattern is perhaps easiest
...
*This is in fact the method of widget instantiation used by carbide, though with some slight
...
In carbide, we are of the opinion that, in the common case, the extra work on behalf of the widget
...
1. We provide a [`builder_methods!`][builder_methods!] macro which reduces the boilerplate of builder method
   implementation.
2. In carbide, widgets are treated as a set of arguments to their state, rather than containing
   their own state themselves. This suits the immediate mode style of carbide, where widget state is
   hidden and stored within the `Ui`.
3. All carbide widgets must take a unique identifier and a mutable reference to the `Ui`. We
...
[5]:  https://github.com/PistonDevelopers/carbide/issues             "carbide Github Issues"
[6]:  https://github.com/PistonDevelopers/carbide/pulls              "carbide Github Pull Requests"
