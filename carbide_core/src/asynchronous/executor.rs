...
// use asynchronous::FutureExt;
//
// // This is currently derived from the iced asynchronous crate.
// pub trait Executor<T> {
//     fn new() -> Result<Box<dyn Executor<T>>, asynchronous::io::Error>;
//
...
//     /// before creating asynchronous. This method can be leveraged to set up this
